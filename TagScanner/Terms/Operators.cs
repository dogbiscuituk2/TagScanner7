    ...
    public static class Operators
    {
        ...
        static Operators()
        {
            OperatorDictionary = new Dictionary<Op, OpInfo>
            {
                ...
                { Op.Conditional, new OpInfo("if-then-else", ExpressionType.Conditional, Rank.Conditional, typeof(object), "{0} ? {1} : {2}", Icons.Op2_Conditional, typeof(bool), typeof(object)) },
                { Op.And, new OpInfo("and", ExpressionType.AndAlso, Rank.ConditionalAnd, typeof(bool), "{0} & {1}", Icons.Op2_And) },
                { Op.Or, new OpInfo("or", ExpressionType.OrElse, Rank.ConditionalOr, typeof(bool), "{0} | {1}", Icons.Op2_Or) },
                { Op.Xor, new OpInfo("exclusive or", ExpressionType.ExclusiveOr, Rank.BitwiseXor, typeof(bool), "{0} ^ {1}", Icons.Op2_Xor) },
                ...
                { Op.Not, new OpInfo("not", ExpressionType.Not, Rank.Unary, typeof(bool), "!{0}", Icons.Op2_Not) },
