    ...
    public static class Operators
    {
        ...
        static Operators()
        {
            ...
            OperationDictionary = new Dictionary<Op, OpInfo>
            {
                ...
                { Op.And, new OpInfo('&', "{0} & {1}", ExpressionType.AndAlso, Rank.ConditionalAnd, Icons.Op2_And) },
                { Op.Or, new OpInfo('|', "{0} | {1}", ExpressionType.OrElse, Rank.ConditionalOr, Icons.Op2_Or) },
                { Op.Xor, new OpInfo('^', "{0} ^ {1}", ExpressionType.ExclusiveOr, Rank.BitwiseXor, Icons.Op2_Xor) },
