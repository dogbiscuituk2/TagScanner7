namespace TagScanner.Tests
{
    ...
    public partial class Test
    {
        ...
        [TestMethod]
        public void CheckMethods() => Assert.IsFalse(Core.Methods.ContainsValue(null));

        [TestMethod]
        public void CheckOperators()
        {
            int count = Core.Operators.Count;
            Assert.AreEqual(expected: count, actual: Enum.GetNames(typeof(Operator)).Length);
            Assert.AreEqual(expected: count, actual: Enum.GetValues(typeof(Operator)).Length);
        }
