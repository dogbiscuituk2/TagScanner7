namespace TagScanner.Tests
{
    ...
    public partial class Test
    {
        ...
        private static readonly Mock[] Works = new[]
        {
            ...
            new Mock(RS, 1971, SF, 1, "3:48", "Brown Sugar") { FileLastAccessTime  = DateTime.Parse("24/01/2024 19:34:00") },
            new Mock(RS, 1971, SF, 2, "3:50", "Sway") { FileLastAccessTimeUtc = DateTime.Parse("24/01/2024 19:34:00") },
            new Mock(RS, 1971, SF, 3, "5:42", "Wild Horses") { FileLastWriteTime  = DateTime.Parse("24/01/2024 19:34:00") },
            new Mock(RS, 1971, SF, 4, "7:14", "Can't You Hear Me Knocking") { FileLastWriteTimeUtc  = DateTime.Parse("24/01/2024 19:34:00") },
            new Mock(RS, 1971, SF, 5, "2:32", "You Gotta Move") { FilePath = @"C:\Music\Stones\You Gotta Move.mp3" },
            new Mock(RS, 1971, SF, 6, "3:38", "Bitch") { FileSize = 2968691L },
            ...
            new Mock(RS, 2023, HD, 9, "3:16", "Driving Me Too Hard") { ImageDateTime = DateTime.Parse("24/01/2024 19:34:00") },
            ...
            new Mock(LZ, 1969, LZ, 8, "4:42", "I Can't Quit You Baby") { ImageOrientation = TagLib.Image.ImageOrientation.TopLeft},
            ...
            new Mock(LZ, 1969, LZii, 2, "4:47", "What Is and What Should Never Be") { InvariantEndPosition = 67890L },
            new Mock(LZ, 1969, LZii, 3, "6:20", "The Lemon Song") { InvariantStartPosition = 12345L },
